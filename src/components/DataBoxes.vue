<template>
  <div class="grid md:grid-cols-2 gap-4">
    <!-- Box 1  -->
    <div class="shadow-md bg-blue-100 p-8 text-center rounded">
      <h3 class="text-3xl text-blue-900 font-bols mb-4">Cases</h3>
    ...
    <div class="shadow-md bg-blue-100 p-10 text-center rounded">
      <h3 class="text-3xl text-blue-900 font-bols mb-4">Deaths</h3>
